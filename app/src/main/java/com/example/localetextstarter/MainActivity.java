...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String formatedExpirationDate = DateFormat.getDateInstance().format(myDate);
        expiredDateTextView.setText(formatedExpirationDate);
        ...
        formatedPrice = mCurrencyFormat.format(mPrice);
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        double quantity = Double.parseDouble(enteredQuantity.getText().toString());
                        ...
                        totalTextView.setText(Double.toString(mTotalPrice));
